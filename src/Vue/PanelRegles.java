...
public class PanelRegles extends JPanel {
    ...
    public void initialiserPanel(int largeur, int hauteur) {
        ...
        LignePanel sous_panel_1 = new LignePanel(largeur_sous_panel, hauteur_sous_panel, Constante.CHEMIN_RESSOURCE+"/artwork/comment_jouer.png", titreCommentJouer, texteCommentJouer);
        LignePanel sous_panel_2 = new LignePanel(largeur_sous_panel, hauteur_sous_panel, Constante.CHEMIN_RESSOURCE+"/artwork/deplacement.png", titreDeplacement, texteDeplacement);
        LignePanel sous_panel_3 = new LignePanel(largeur_sous_panel, hauteur_sous_panel, Constante.CHEMIN_RESSOURCE+"/artwork/construction.png", titreConstruction, texteConstruction);
    ...
    private class ReglesPanel extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            try {
                BufferedImage bg_regles = ImageIO.read(new File(Constante.CHEMIN_RESSOURCE+"/artwork/bg_regles.png"));
                g2d.drawImage(
                        bg_regles,
                        0,
                        0,
